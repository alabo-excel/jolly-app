...
function Home(props) {
  ...
  if(props.music == null){
    ...
    const bookList = props.books.splice(0, 3).map(book =>{
        return(
            <div key={book.id} className="card col-lg-3 col-sm-12 mx-lg-5 mt-3">
              <div className="card-body d-flex">
                <img id={book.id} src={book.volumeInfo.imageLinks.smallThumbnail} alt={book.id} />
                <div className="pl-3">
      ...
      const musics = props.music.tracks.splice(0, 3).map(music =>{
          return(
